...
locals {
  ...
  random_safe_generation = var.unique-length > 0 ? join("", [random_string.first_letter[0].result, random_string.main[0].result]) : ""
  random                 = (var.unique-length > 0 || var.unique-seed != "") ? substr(coalesce(var.unique-seed, local.random_safe_generation), 0, var.unique-length) : ""
